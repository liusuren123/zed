...
impl ManageProfilesModal {
    ...
    fn new_profile(
        ...
        name_editor.update(cx, |editor, cx| {
            editor.set_placeholder_text(&translate("Profile name", cx), window, cx);
        });
                    ...
                    v_flex()
                        ...
                        .when(!mode.custom_profiles.is_empty(), |this| {
                            this.child(ListSeparator)
                                .child(
                                    div().pl_2().pb_1().child(
                                        Label::new(translate("Custom Profiles", cx))
                                            .size(LabelSize::Small)
                                            .color(Color::Muted),
                                    ),
                                )
                            ...
                            div()
                                ...
                                .child(
                                    ListItem::new("new-profile")
                                        ...
                                        .child(Label::new(translate("Add New Profile", cx)))
                                        .on_click({
                                            cx.listener(move |this, _, window, cx| {
                                                this.new_profile(None, window, cx);
                                            })
        ...
        v_flex()
            ...
            .child(ProfileModalHeader::new(
                match &base_profile_name {
                    ...
                    None => translate("New Profile", cx).to_string(),
                },
                match base_profile_name {
                            ...
                            div()
                                ...
                                .child(
                                    ListItem::new("fork-profile")
                                        ...
                                        .child(Label::new(translate("Fork Profile", cx)))
                                        .on_click({
                                            let profile_id = mode.profile_id.clone();
                                            cx.listener(move |this, _, window, cx| {
                                                this.new_profile(
                            ...
                            div()
                                ...
                                .child(
                                    ListItem::new("model-item")
                                        ...
                                        .child(Label::new(translate("Configure Default Model", cx)))
                                        .on_click({
                                            let profile_id = mode.profile_id.clone();
                                            cx.listener(move |this, _, window, cx| {
                                                this.configure_default_model(
                            ...
                            div()
                                ...
                                .child(
                                    ListItem::new("configure-mcp-tools")
                                        ...
                                        .child(Label::new(translate("Configure MCP Tools", cx)))
                                        .on_click({
                                            let profile_id = mode.profile_id.clone();
                                            cx.listener(move |this, _, window, cx| {
                            ...
                            div()
                                ...
                                .child(
                                    ListItem::new("delete-profile")
                                        ...
                                        .child(
                                            Label::new(translate("Delete Profile", cx))
                                                .color(Color::Error),
                                        )
                            ...
                            div()
                                ...
                                .child(
                                    ListItem::new("cancel-item")
                                        ...
                                        .child(Label::new(translate("Go Back", cx)))
                                        .end_slot(
                                            div().child(
