...
pub fn init(themes_to_load: LoadThemes, cx: &mut App) {
    ...
    let (
        ...
        prev_git_commit_buffer_font_size_settings,
        prev_theme_name,
    ...
    let mut prev_git_commit_buffer_font_size_settings = prev_git_commit_buffer_font_size_settings;
    ...
    cx.observe_global::<SettingsStore>(move |cx| {
        let (
            ...
            git_commit_buffer_font_size_settings,
            theme_name,
            icon_theme_name,
            theme_overrides,
            ui_language,
